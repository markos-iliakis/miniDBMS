...
void quicksort(BF_Block** buffer, int fieldNo, int low, int low_block, int high, int high_block, int );
part_return partition(BF_Block** buffer, int fieldNo, int low, int low_block, int high, int high_block, int );
int compare(Record *r1, Record *r2, int type);
void swap(Record *, char *, int, Record *, char *, int);
void mergesort(BF_Block*** buffer, int fieldNo, int low, int low_block, int high, int high_block, int bufferSize);
void merge(BF_Block*** buffer, int i1, int i1_block, int j1, int j1_block, int i2, int i2_block, int j2, int j2_block, int bufferSize);
int getEntriesNo(BF_Block* block);

int k_way_merge(BF_Block** buffer, int buffersize, int runSize, int fielNo, int *groups, int outpout_filedesc, int );
